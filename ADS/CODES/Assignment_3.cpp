...
public:
  ...
  void create_root_and_tree_iteratively ()
  {
	...
	while (!flag)
	  {
	    if (strcmp (current_word->word.c_str (), temp->word.c_str ()) <=
		0)
	      {
		if (temp->left == NULL)
		  {
...
main ()
{
  ...
  while (choice != 10)
	...
	<< endl;
      ...
      cout << "2. Traverse the Tree Inorder Iteratively" << endl;
      cout << "3. Traverse the Tree PreOrder Iteratively" << endl;
      cout << "4. Traverse the Tree PostOrder Iteratively" << endl;
      cout << "5. Traverse it using BFS" << endl;
      cout << "6. Create a Copy of the tree Recursively and Iteratively"
	<< endl;
      cout << "7. Create a Mirror of the Tree Recursively" << endl;
      cout << "8. Create a Mirror of the Tree Iteratively" << endl;
      cout << "9. Delete a Node from the Tree" << endl;
	...
	case 1:
	  ...
	  break;
	case 2:
	  cout << "Traversing through the Binary Tree Inorder Iteratively: "
	    << endl;
	  main_tree.inorder_iterative (main_tree.root);
	  break;
	case 3:
	  cout << "Traversing through the Binary Tree PreOrder Iteratively: "
	    << endl;
	  main_tree.preorder_iterative (main_tree.root);
	  break;
	case 4:
	  cout << "Traversing through the Binary Tree PostOrder Iteratively: "
	    << endl;
